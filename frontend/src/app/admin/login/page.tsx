    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background:'#f8f7f4' }}>
      ...
      <motion.div initial={{ opacity:0,y:24,scale:0.97 }} animate={{ opacity:1,y:0,scale:1 }}
        ...
        <div className="rounded-2xl p-8"
             style={{ background:'rgba(255,255,255,0.92)', border:'1px solid rgba(0,0,0,0.09)', boxShadow:'0 8px 60px rgba(0,0,0,0.5)' }}>
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="font-display font-bold text-center" style={{ color:'#111827', fontSize:'1.5rem', letterSpacing:'-0.03em' }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <Lock size={14} className="absolute left-3.5 top-1/2 -translate-y-1/2" style={{ color:'#d1d5db' }}/>
